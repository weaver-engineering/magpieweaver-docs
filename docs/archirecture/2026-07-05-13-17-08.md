...
modified: 2026-07-05T13:17:15+01:00
---
...
(§§5, 10), and the development-process gate governing all agent-authored
code (§12.3) — together the highest-risk areas in the original source
...
underlying abstractions are sound. Remaining open items (§12.1, §12.4–12.6,

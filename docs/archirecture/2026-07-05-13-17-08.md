...
modified: 2026-07-06T12:27:51+01:00
---
...
during subsequent design review are tracked as ADR-006 through ADR-020 in a
...
finalized**), and local observability tooling (020). Note: ADR-001's stated rationale (LLM training-token density)
